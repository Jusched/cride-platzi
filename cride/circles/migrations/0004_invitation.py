...
class Migration(migrations.Migration):
    ...
    dependencies = [
        ...
        ('circles', '0003_membership_circle_members'),
    ]
    ...
    operations = [
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('issued_by', models.ForeignKey(help_text='Circle member providing the invitation.', on_delete=django.db.models.deletion.CASCADE, related_name='issued_by', to=settings.AUTH_USER_MODEL)),
