    ...
    operations = [
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('phone_number', models.CharField(blank=True, max_length=15, validators=[django.core.validators.RegexValidator(message='Phone number must be entered in the format: +11 1111111111. Up to 15 digits.', regex='\\+?1?\\d{9,15}$')])),
                ...
                ('is_verified', models.BooleanField(default=False, help_text='Set to true when the email has verified its email address.', verbose_name='verified')),
